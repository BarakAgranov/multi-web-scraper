...
public interface ISearchStepService {
     ...
     */
    @Operation(
            summary = "${api.search-step-service.create-search-step.description}",
            description = "${api.search-step-service.create-search-step.notes}")
    @ApiResponses(value = {
    ...
    void createStep(@RequestBody SearchStepDto searchStep);
     ...
     */
    @Operation(
            summary = "${api.search-step-service.update-search-step.description}",
            description = "${api.search-step-service.update-search-step.notes}")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "${api.responseCodes.ok.description}"),
            @ApiResponse(responseCode = "800", description = "${api.responseCodes.generalError.description}"),
            @ApiResponse(responseCode = "803", description = "${api.responseCodes.notFound.description}"),
    ...
    @PutMapping(
            value = "/step",
            consumes = "application/json")
    void updateStep(@RequestBody SearchStepDto searchStep);
     ...
     */
    @Operation(
            summary = "${api.search-step-service.delete-search-step.description}",
            description = "${api.search-step-service.delete-search-step.notes}")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "${api.responseCodes.ok.description}"),
            @ApiResponse(responseCode = "800", description = "${api.responseCodes.generalError.description}"),
            @ApiResponse(responseCode = "803", description = "${api.responseCodes.notFound.description}"),
     ...
     */
    @Operation(
            summary = "${api.search-step-service.get-search-step.description}",
            description = "${api.search-step-service.get-search-step.notes}")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "${api.responseCodes.ok.description}"),
            @ApiResponse(responseCode = "800", description = "${api.responseCodes.generalError.description}"),
            @ApiResponse(responseCode = "803", description = "${api.responseCodes.notFound.description}"),
     ...
     * Sample usage: "curl $HOST:$PORT/search".
     *
     * @return Search info, if found, else null
     */
    @Operation(
            summary = "${api.search-step-service.get-search-step.description}",
            description = "${api.search-step-service.get-search-step.notes}")
