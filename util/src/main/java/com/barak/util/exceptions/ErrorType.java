...
public enum ErrorType {
    ...
    INVALID_INPUT(807, "INVALID_INPUT", "the input you entered is invalid", false),
    ...
    BAD_REQUEST(400, "BAD_REQUEST", "invalid format of the request. See response message for more information",true);
